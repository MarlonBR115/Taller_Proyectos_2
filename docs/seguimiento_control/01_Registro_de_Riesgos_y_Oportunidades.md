...
| RT-06 | Tecnico / Calidad | Reportes de calidad y seguridad muy básicos. | La documentación actual sobre calidad del código (SonarQube) y seguridad (OWASP) es muy general, lo que genera dudas sobre qué tan seguro y bien hecho está el proyecto. | Media | Alto | Alta | Detallar mejor los reportes de calidad y arreglar los problemas de seguridad detectados. | Usar el buen funcionamiento de nuestras pruebas automatizadas para dar confianza mientras se mejoran los reportes. | Responsable de Documentacion y Calidad | Reportes de SonarQube y OWASP | Activo |
...
| RO-04 | Organizacional / Operativo | Ausencia de miembros del equipo en presentaciones. | Si un responsable falta a una exposición importante, el equipo se queda sin su experto en esa área, afectando la defensa general del proyecto. | Media | Alto | Alta | Asegurar que todos los miembros entiendan bien todo el proyecto para poder cubrir a un compañero si llega a faltar. | Repartir el tema del compañero ausente entre los miembros que sí asistieron. | Scrum Master | Matriz de responsabilidades | Activo |
...
| OP-06 | Aprovechar que nuestras pruebas automatizadas funcionan muy bien. | Tenemos un conjunto de pruebas muy completo que revisa el sistema automáticamente y casi sin errores. | Nos da la seguridad de que al agregar nuevas funciones, no vamos a romper lo que ya funciona. | Seguir usando estas pruebas como nuestra mejor garantía de que el proyecto es estable. | Responsable de Backend y Calidad | Reportes de Testing | Alta |
