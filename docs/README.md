...
Este indice es la puerta de entrada a la documentacion academica y tecnica del proyecto. La fuente principal de cada tema se indica para evitar duplicidad y contradicciones.
...
| Documento | Proposito |
|---|---|
| [SDD README](sdd/README.md) | Indice de documentacion SDD. |
| [constitution.md](sdd/constitution.md) | Reglas de gobernanza, calidad, TDD y documentacion. |
| [agents.md](sdd/agents.md) | Roles y responsabilidades tecnicas. |
| [specs.md](sdd/specs.md) | Especificaciones verificables y trazabilidad tecnica. |

## 4. Ejecucion y evidencias

| Documento | Proposito |
|---|---|
| [Ejecucion README](ejecucion/README.md) | Indice de evidencias tecnicas. |
| [HU03 - Motor Anti-Cruces](ejecucion/hu03-motor-anti-cruces.md) | Fuente principal de HU03. |
| [Evidencia TDD HU03](ejecucion/evidencia-tdd-hu03.md) | Pruebas unitarias de HU03. |
| [Metricas HU03](ejecucion/metricas-hu03.md) | Metricas calculadas por HU03. |
| [Heuristicas CSP](ejecucion/a003-02-heuristicas-reglas.md) | Reglas y heuristicas del motor CSP. |

## 5. Seguimiento y control

| Documento | Proposito |
|---|---|
| [Seguimiento README](seguimiento_control/README.md) | Indice de seguimiento. |
